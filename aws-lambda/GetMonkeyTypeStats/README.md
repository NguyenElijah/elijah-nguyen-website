...
Since github pages are entirely client side, doing an api in the react app itself would have exposded my APE Key (monkeytype calls API keys APE keys. Funny)
